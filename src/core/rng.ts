/**
 * Seeded random numbers (SPEC §7.6): every mission replays identically from its seed.
 * Shared by the generators and the elapsed-time choices; no other module rolls dice.
 */
